...
int main()
{
	...
	while(menu==1){ // menggunakan while karena batasannya tidak diketahui
		cout<<"---------------------------------------------"<<endl;
		cout<<"Input Nama barang\t\t: "; cin>>a[jml];
		cout<<"Input Kuantitas (jumlah barang)\t: "; cin>>p[jml];
		cout<<"Harga barang(per item)\t\t: "; cin>>q[jml];
		cout<<"---------------------------------------------"<<endl;
		cout<<"Masukkan barang lagi? [1 = YA, 2 = TIDAK]"<<endl; cin>>menu;
	...
	struk<<"============================================="<<endl;
	for(int i = 0; i<jml; i++){
		struk<<"Nama barang\t: "<<a[i]<<endl;
		struk<<"Harga barang\t: "<<p[i]<<" x "<<q[i]<<endl;
